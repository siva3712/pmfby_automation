...
class MainWindow:
    ...
    def start_upload(self):
        ...
        self.upload_worker()
        # self.root.update_idletasks()  # Force Tkinter to refresh button states visually

        # # Run upload in background thread so the GUI stays responsive to the Cancel button
    ...
    def login(self):
        ...
        # Run directly on the main thread
        self.login_worker()
        # self.write.log("Logging in...  Please wait...")
        # self.root.update_idletasks()

        # Run login worker in background thread
